        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              if(!upi)...[
                Text("Banking Name: Mahesh Birla",style: Const.font_500_16(context,color: Color.fromRGBO(190, 190, 190, 1)),),
                SizedBox(height: SC.from_width(5),),

                Text("Account No. XXXXXXXX1234",style: Const.font_500_16(context,color: Color.fromRGBO(190, 190, 190, 1)),),
              ]
              else...[
                Text("UPI ID: maheshbirla544@YBI",style: Const.font_500_16(context,color: Color.fromRGBO(190, 190, 190, 1)),),
              ],
              ...
              // ),
              SizedBox(height: SC.from_width(14),),
              CustomActionButton(action: (){},lable: 'Withdrawal Request',),
              SizedBox(height: SC.from_width(20),)
