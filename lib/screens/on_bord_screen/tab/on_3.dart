...
class On3 extends StatelessWidget {
  ...
  const On3({required this.controller,super.key});
        ...
        children: <Widget>[
          ...
          Positioned(
              ...
              child: Row(
                ...
                children: [
                  Text("Your Mind Matters",style: Const.font_900_30(context),),
                ],
              )),
          ...
          Positioned(
              ...
              child:AspectRatio(
                ...
                child: Container(
                  ...
                  child: Image.asset("assets/onboard/image (4).png",),
                ),
              )),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text('Balance Your Mind',style: Const.font_500_24(context),),
                    SizedBox(height: SC.from_width(15),),
                    Text("Release stress, gain clarity, and improve your emotional well-being with a simple conversation"
